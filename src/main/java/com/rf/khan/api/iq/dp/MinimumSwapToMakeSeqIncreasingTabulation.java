 ...
 *
 */
public class MinimumSwapToMakeSeqIncreasingTabulation {
	...
	public int minSwap(int[] nums1, int[] nums2) {
		...
		return solveUsingTabulation(newNum1, newNum2);
	}
	 ...
	 * @return
	 */
	private int solveUsingTabulation(int[] nums1, int[] nums2) {
	...
	public static void main(String[] args) {
		...
		MinimumSwapToMakeSeqIncreasingTabulation min = new MinimumSwapToMakeSeqIncreasingTabulation();
